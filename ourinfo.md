...
I enjoy working at the intersection of **AI, no-code tools, design, automation, and personal development**. I build things not just to ship them, but to understand systems deeply and improve myself in the process.

---

## 🧠 What I Do

- Build **small apps, tools, and websites** using AI, no-code, and lightweight tech
- Experiment with **AI workflows** to automate ideas and simplify complex tasks
- Design and contribute to **digital assets and creative projects**
- Create content around **discipline, fitness, self-improvement, and stoic thinking**
- Continuously improve my **English communication and clarity of thought**

I prefer practical execution over theory, clean systems over noise, and steady progress over shortcuts.

---

## 🏋️‍♂️ Discipline & Growth
...
The same mindset applies to my work — **show up daily, improve incrementally, and trust the process**.
...
- 📸 **Instagram**  
  No-code, AI experiments, creator life  
  https://www.instagram.com/no.code_boopul
...
This page connects everything I’m building, learning, and sharing.  
