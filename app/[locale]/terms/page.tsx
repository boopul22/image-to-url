...
export async function generateMetadata({
    ...
    return {
        title: dict.pages.terms.metaTitle,
        description: dict.pages.terms.metaDescription,
        alternates: {
        ...
        <>
            <BreadcrumbJsonLd
                items={[
                    ...
                    { name: dict.pages.terms.title, url: `https://www.imagetourl.cloud/${locale}/terms` }
                ]}
            />
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
                                {dict.pages.terms.metaDescription}
                            </p>
                        </div>

                        <div className="space-y-12 mb-16">
                            {dict.pages.terms.sections.map((section, index) => (
                        ...
                        <section className="text-center">
                            <div className="bg-gradient-to-r from-brand/10 to-blue-500/10 border border-zinc-800 rounded-2xl p-8">
                                ...
                                <p className="text-zinc-500 text-sm mt-6">{dict.pages.terms.lastUpdated}</p>
                            </div>
                        </section>
                    </div>
                </main>
